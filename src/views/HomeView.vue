                ...
                <div class="container">
                    <div class="row z-index-1">
                        <div class="col-lg-12 text-center mt-1">
                            <h1 class="text-white">
                                We are dedicated to <TypingAnimation :strings="['Giving']" :typeSpeed="250"
                            ...
                            <p class="lead text-white text-center px-5 mt-4">
                                ...
                                <br />
                                Our goal is to empower and support non-profits and ordinary people in Africa receive
                                donations and do more for their communities.
                            </p>
                            <br />
                            <div class="buttons">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                            <div class="p-3 text-start border-radius-lg">
                                                <div
                                                    class="icon icon-shape icon-md bg-primary shadow text-center">
                                                    <svg width="30px" height="18px" viewBox="0 0 43 36" version="1.1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" class="mt-3">
                                                ...
                                                <h5 class="mt-3">Start A Raiser</h5>
                                                <p>Creativity starts with an empty calendar and ends with a full one.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                            <div class="p-3 text-start bg-white border-radius-lg shadow-lg">
                                                <div
                                                    class="icon icon-shape icon-md bg-gradient-primary shadow text-center">
                                                    <svg width="30px" height="18px" viewBox="0 0 40 40" version="1.1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" class="mt-3">
                                        ...
                                        <div class="col-xl-3 col-md-4 py-md-5 py-3">
                                            <div class="p-3 text-start border-radius-lg">
                                                <div
                                                    class="icon icon-shape icon-md bg-primary shadow text-center">
                                                    <svg width="30px" height="18px" viewBox="0 0 42 44" version="1.1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" class="mt-3">
                                                        <title>basket</title>
                                                        <g stroke="none" stroke-width="1" fill="none"
                                                            fill-rule="evenodd">
                                                            <g transform="translate(-1869.000000, -741.000000)"
                                                                fill="#FFFFFF" fill-rule="nonzero">
                                                                <g transform="translate(1716.000000, 291.000000)">
                                                                    <g id="basket"
                ...
                <div class="row mt-0 mb-10 mt-3">
                    <div class="col-lg-7 col-md-12 me-auto">
                        <div class="p-3 pt-0 position-sticky">
                            ...
                            <h1 class="text-gradient text-primary mb-0">The Impact of Donner </h1>
                            <h5 class="mb-4">Learn more about our efforts</h5>
            ...
            <div class="container position-relative z-index-2">
                <div class="row">
                    <div class="col-lg-7 col-md-7 m-auto text-start">
                        <h5 class="text-white mb-lg-0 mb-5 text-start">
                            Your donation, no matter how small, is an investment in a
                            better future. Together, we create opportunities and unlock potential.
                        </h5>
                    </div>
